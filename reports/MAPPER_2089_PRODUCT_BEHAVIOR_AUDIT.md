# Mapper 2089 Product Behavior Audit
...
- Mapper rows: **2089**
- Unique Mapper IDs: **2089**
- Process rows joined: **2089**
- Mapper SHA-256: `057375cd60cefe613892ff1d9f8f7eda880ff0eb06732f9229051fc37d8deca7` (pinned)
- Process SHA-256: `44fd5302c7a2372bb69ba5abc592edd27f41e96c5de00ac2ca45ade1903ad6d6` (pinned)
...
- structural_product_not_flavour_main: **120**
...
- OWNER_GELLATTI_BLEND_HEAT_HYDRATION: **1**
- TARA_FULL_HYDRATION_REQUIRES_WARM_WATER: **1**
- XANTHAN_COLD_SOLUBLE: **1**

## Science boundary

- Exact governed Main coverage: **110 / 2089** identity bindings (profile applicability remains explicit per row).
- Runtime role classification is exhaustive: **2089 / 2089**.
