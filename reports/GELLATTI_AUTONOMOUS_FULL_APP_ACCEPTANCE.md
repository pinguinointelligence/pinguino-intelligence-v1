...
| PC-03 | HIGH | **CORRECTED + FIXED.** The 22 recorded cells are harness artefacts — `buildInput` appends rotation ingredients without budgeting them (1030/1050 g against 1000 g) and the Sorbet extra bypasses the stabilizer clamp. Neither citrus fibre nor NEAREST coverage was causal: the exact projection already returns a 0-violation candidate. The real defect was eligibility — the Sorbet exact projection required the incoming draft to already be on batch, although it solves FOR the target batch. Off-batch drafts took the ~50–92 s general path and at ±30 g published a violating proposal. | 22 |
