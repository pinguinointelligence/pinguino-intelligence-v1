...
| D-CODE-03 | Codes | Global uniqueness across every Partner, live availability validation | 🟡 | ✅ | ⬜ | ⬜ | 🔓 | `b4e3a187` | Global unique indexes written; `gellatti_partner_code_claim_refusal_v1` gives live typed availability | Wire the availability check into the UI — DB side applied |
