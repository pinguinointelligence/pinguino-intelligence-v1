...
export function toMapperKnowledgeRow(row: IngredientRow): MapperKnowledgeRow {
  return {
    ...
    sucrose_percent: row.sucrose_percent,
    dextrose_percent: row.dextrose_percent,
    glucose_percent: row.glucose_percent,
    fructose_percent: row.fructose_percent,
    lactose_percent: row.lactose_percent,
