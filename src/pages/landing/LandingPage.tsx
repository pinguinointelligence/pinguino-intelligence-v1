  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-7">
        ...
        <Link
          to="/demo"
          className="rounded-md border border-ink/15 px-5 py-2.5 text-sm font-medium transition-colors hover:border-ink/40"
        >
          {landing.ctaPrimary}
        </Link>
      </header>
      ...
      <section className="mx-auto max-w-6xl px-6 pt-24 pb-28 md:pt-32 md:pb-36">
        ...
        <div className="mt-12 flex items-center gap-8">
          <Link
            to="/demo"
            className="rounded-md bg-ink px-7 py-3.5 text-sm font-medium text-paper transition-colors hover:bg-ink-soft"
          >
            {landing.ctaPrimary}
          </Link>
          <a
      ...
      <section id="modes" className="bg-ink text-ivory">
        <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
          <p className="text-xs font-medium tracking-label text-ivory-soft uppercase">
            {landing.modesEyebrow}
          </p>
