...
export function ShopPage() {
  ...
  return (
    <DestinationSurface
      ...
      /* OWNER OVERRIDE (2026-09-01): the ONE global Gellatti header — the
         official wordmark alone and HOME | PRO at the trailing edge of the
         primary column, identical to HOME and PRO. The Shop adds nothing to
         that row: the basket lives BELOW it, on the Shop's own utility line. */
      canonicalHeader
