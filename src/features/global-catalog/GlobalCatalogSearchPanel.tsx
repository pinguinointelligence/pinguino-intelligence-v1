  ...
  return (
    <section className="mt-2" aria-label="Katalog Gellatti">
      ...
      <div className="mt-3 grid min-w-0 gap-3 lg:grid-cols-[minmax(340px,0.85fr)_minmax(420px,1.15fr)]">
        <div className="min-w-0 overflow-hidden rounded-[12px] border border-ink/12 bg-white shadow-pro-e0">
          {baseHits.length > 0 ? (
        ...
        <aside className="order-first min-w-0 rounded-[12px] border border-ink/12 bg-[#f7f3ed] p-4 shadow-pro-e0 lg:order-none lg:sticky lg:top-4 lg:h-max">
