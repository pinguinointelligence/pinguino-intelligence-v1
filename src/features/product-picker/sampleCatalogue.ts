...
export const SAMPLE_CATALOGUE: readonly PickerCatalogueEntry[] = [
  // — Czekolada —
  sample({
    productId: 'PSAMPLE-choc-1',
    displayName: 'Hacendado Chocolate Negro 70%',
    brand: 'Hacendado',
    category: 'czekolada',
    packageSize: '125 g',
    ean: '8480000123456',
  ...
  sample({
    productId: 'PSAMPLE-choc-2',
    displayName: 'Lindt Excellence 70% Cacao',
    brand: 'Lindt',
    category: 'czekolada',
    packageSize: '100 g',
    ean: '3046920022606',
    status: 'draft',
    mapperStatus: 'matched',
    matchedBasementId: 'REF-COCOA-70',
  }),
  sample({
    productId: 'PSAMPLE-choc-3',
    displayName: 'Valrhona Guanaja 70%',
    brand: 'Valrhona',
    category: 'czekolada',
    packageSize: '250 g',
    status: 'draft',
  ...
  sample({
    productId: 'PSAMPLE-whisky-2',
    displayName: "Ballantine's Finest",
    brand: "Ballantine's",
    category: 'whisky',
    packageSize: '700 ml',
    status: 'draft',
  ...
  // — Rum —
  sample({
    productId: 'PSAMPLE-rum-1',
    displayName: 'Bacardi Carta Blanca',
    brand: 'Bacardi',
    category: 'rum',
    packageSize: '700 ml',
    status: 'draft',
  ...
  sample({
    productId: 'PSAMPLE-rum-2',
    displayName: 'Havana Club Añejo 3 Años',
    brand: 'Havana Club',
    category: 'rum',
    packageSize: '700 ml',
    status: 'draft',
  ...
  // — Malina / puree —
  sample({
    productId: 'PSAMPLE-rasp-1',
    displayName: 'Puree malinowe 100% (Boiron)',
    brand: 'Boiron',
    category: 'owoce',
    packageSize: '1 kg',
    status: 'draft',
  ...
  sample({
    productId: 'PSAMPLE-rasp-2',
    displayName: 'Malina mrożona',
    category: 'owoce',
    packageSize: '1 kg',
    status: 'draft',
    mapperStatus: null,
  ...
  // — Pasta pistacjowa —
  sample({
    productId: 'PSAMPLE-pist-1',
    displayName: 'Pasta pistacjowa 100%',
    category: 'pasta orzechowa',
    packageSize: '200 g',
    status: 'draft',
    mapperStatus: 'needs_review',
  }),
  // — Zioła (fresh) —
  sample({
    productId: 'PSAMPLE-herb-1',
    displayName: 'Bazylia świeża',
    category: 'zioła',
    packageSize: 'pęczek',
    status: 'draft',
    mapperStatus: null,
  ...
  sample({
    productId: 'PSAMPLE-herb-2',
    displayName: 'Mięta świeża',
    category: 'zioła',
    packageSize: 'pęczek',
    status: 'draft',
    mapperStatus: null,
  ...
  // — Stabilizator —
  sample({
    productId: 'PSAMPLE-stab-1',
    displayName: 'Stabilizator Gellatti',
    brand: 'GELLATTI',
    category: 'stabilizator',
    packageSize: '1 kg',
    status: 'draft',
    mapperStatus: 'needs_review',
  }),
