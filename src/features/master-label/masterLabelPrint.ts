...
export function buildMasterLabelPrintHtml(
  ...
  const logo =
    logoUrl && data.enabledOptionalFields.includes('logo')
      ? `<img class="label-logo" src="${escapeHtml(logoUrl)}" alt="">`
      : '';
