    ...
    <>
      ...
      <div className="mt-7 space-y-4">
        {(query.data ?? []).map((report) => (
          <article key={String(report.id)} className="border-y border-ink/10 py-5">
            <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_auto]">
              <div>
                <div className="flex flex-wrap gap-2 text-[10px] font-semibold uppercase tracking-[0.1em] text-stone-500">
