...
export const APP_NAV_ITEMS: readonly AppNavItem[] = [
  ...
  { id: 'proHome', label: s.items.proHome, to: '/pro', group: 'main', order: 3, isActive: anyPro },
  {
    ...
    group: 'main',
    order: 4,
    isActive: exact('/recipes'),
    readiness: partial(
      'Tylko Moje receptury prowadzą do kompletnej funkcji.',
      'Nie wpływa na obliczenia.',
      'Podłączyć katalogi gotowych receptur.',
    ),
  },
  {
    id: 'myRecipes',
    label: s.items.myRecipes,
    to: '/my-recipes',
    group: 'main',
    order: 5,
    isActive: exact('/my-recipes'),
  },
  {
    id: 'machine',
    ...
    group: 'main',
    order: 6,
    isActive: exact('/profile/machine'),
    readiness: partial(
      'Ustawienie zapisuje się na urządzeniu, nie na koncie.',
      'Może pozostawić niespójny kontekst po zmianie urządzenia.',
      'Podłączyć synchronizację konta i zweryfikować pojemność.',
    ),
  },
  {
    id: 'labels',
    ...
    group: 'main',
    order: 7,
    isActive: exact('/label'),
    readiness: preparing(
      'Eksport korzysta z receptury przykładowej.',
      'Nie zmienia bieżącej receptury.',
      'Podłączyć aktualną recepturę i zweryfikowane deklaracje.',
    ),
  },
  {
    id: 'subscription',
    label: s.items.subscription,
    to: '/subscription',
    group: 'main',
    order: 8,
  ...
  {
    id: 'createIngredient',
    label: s.items.createIngredient,
    to: '/create-ingredient',
    group: 'main',
    order: 10,
    isActive: exact('/create-ingredient'),
    readiness: preparing(
      'OCR, aparat i zapis składnika nie są podłączone.',
      'Nie wpływa na obliczenia receptury.',
      'Podłączyć pobranie danych, walidację i zapis.',
    ),
  },
  {
    id: 'api',
    ...
    isActive: exact('/api'),
    readiness: preparing(
      'Publiczne API i dokumentacja nie są dostępne.',
      'Nie wpływa na obliczenia.',
      'Udostępnić kontrakt, autoryzację i status API.',
    ),
  },
  {
    id: 'productImport',
    label: s.items.productImport,
    to: '/products/import',
    group: 'main',
    order: 12,
    isActive: exact('/products/import'),
  },

  // ── PINGÜINO PRO (stable /pro/<section> paths; Pro capability only) ──
  {
    id: 'proRecipe',
    label: s.items.proRecipe,
    to: '/pro/recipe',
    group: 'pro',
    order: 11,
    requires: 'pro',
    isActive: proRecipeActive,
  },
  {
    id: 'proMonitor',
    label: s.items.proMonitor,
    to: '/pro/monitor',
    group: 'pro',
    order: 12,
    requires: 'pro',
    isActive: proSection('monitor'),
  },
  {
    id: 'proVersions',
    label: s.items.proVersions,
    to: '/pro/versions',
    group: 'pro',
    order: 13,
    requires: 'pro',
    isActive: proSection('versions'),
    decision: 'DO PRZEGLĄDU',
  },
  {
    id: 'proProduction',
    label: s.items.proProduction,
    to: '/pro/production',
    group: 'pro',
    order: 14,
    requires: 'pro',
    isActive: proSection('production'),
  },
  {
    id: 'proHistory',
    label: s.items.proHistory,
    to: '/pro/history',
    group: 'pro',
    order: 15,
    requires: 'pro',
    isActive: proSection('history'),
    readiness: preparing(
      'Historia produkcji nie ma interfejsu danych.',
      'Nie wpływa na bieżące obliczenia.',
      'Podłączyć trwałe przebiegi produkcyjne.',
    ),
  },
  {
    id: 'proCosts',
    label: s.items.proCosts,
    to: '/pro/costs',
    group: 'pro',
    order: 16,
    requires: 'pro',
    isActive: proSection('costs'),
    decision: 'DO PRZEGLĄDU',
  },
  {
    id: 'proExports',
    label: s.items.proExports,
    to: '/pro/exports',
    group: 'pro',
    order: 17,
    requires: 'pro',
    isActive: proSection('exports'),
    readiness: preparing(
      'Eksport aktualnej receptury nie jest podłączony.',
      'Nie wpływa na obliczenia.',
      'Podłączyć aktualne dane receptury i formaty eksportu.',
    ),
  },
  {
    id: 'proSettings',
    label: s.items.proSettings,
    to: '/pro/settings',
    group: 'pro',
    order: 18,
    requires: 'pro',
    isActive: proSection('settings'),
    decision: 'DO PRZEGLĄDU',
  },
  ...
  {
    id: 'proMachine',
    label: s.items.proMachine,
    to: '/pro/machine',
    group: 'pro',
    order: 19,
    requires: 'pro',
    isActive: proSection('machine'),
  },
  {
    id: 'proTools',
    label: s.items.proTools,
    to: '/pro/tools',
    group: 'pro',
    order: 20,
    requires: 'pro',
    isActive: proSection('tools'),
    decision: 'DO PRZEGLĄDU',
  },
];
