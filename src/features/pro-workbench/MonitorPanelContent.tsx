...
export function MonitorPanelContent({
  ...
  return (
    <div className="space-y-3 text-ink" data-testid="monitor-panel-content">
      ...
      {technicalView ? <ProfessionalMonitorModules modules={modules} /> : <LockedPIPreview />}
      ...
      >
        <summary className="flex cursor-pointer list-none items-center justify-between gap-2 px-3 py-2 text-[10px] font-semibold tracking-[0.06em] text-stone-600 uppercase">
          ...
          <span className="border border-nonprod/30 bg-nonprod/[0.04] px-1.5 py-0.5 text-[8px] text-nonprod">
            DO PRZEGLĄDU
          </span>
        </summary>
        <div className="border-t border-ink/8 p-2">
