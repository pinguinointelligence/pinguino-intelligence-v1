...
const PINS: Pin[] = [
  // MAPPER 2147 RE-PIN (2026-09-08): exact generated toolbox authority moved
  // PI-ING-000494 to the corrected Dextrose Monohydrate facts. Verdicts,
  // outcomes and hard-safety classifications remain unchanged; continuous
  // metrics and a few iteration counts below record the new exact Engine truth.
