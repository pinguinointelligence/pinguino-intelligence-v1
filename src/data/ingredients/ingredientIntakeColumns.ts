...
export const INGREDIENT_INTAKE_COLUMNS: readonly IngredientIntakeColumn[] = [
  /* ── identity / approval / verification ─────────────────────────────────── */
  {
    ...
    required: true,
    defaultValue: '',
    description: 'Stable unique id (snake_case). Never reused or renamed once assigned.',
  },
  {
    key: 'ingredient_name_internal',
    label: 'Internal name',
    type: 'string',
    required: true,
    defaultValue: '',
    description: 'Internal canonical name used by tooling/engine mapping.',
  },
  {
    key: 'ingredient_name_display',
    label: 'Display name',
    type: 'string',
    required: true,
    defaultValue: '',
    description: 'Human-facing name shown in the app.',
  },
  {
    key: 'brand',
    label: 'Brand',
    ...
    required: false,
    defaultValue: '',
    description: 'Brand name, if applicable. Blank if unknown.',
  },
  {
    key: 'supplier',
    label: 'Supplier',
    ...
    required: false,
    defaultValue: '',
    description: 'Supplier / distributor. Blank if unknown.',
  },
  {
    key: 'country',
    label: 'Country',
    ...
    required: false,
    defaultValue: '',
    description: 'Country of origin / sourcing. Blank if unknown.',
  },
  {
    key: 'ean_code',
    label: 'EAN code',
    ...
    required: false,
    defaultValue: '',
    description: 'Barcode / EAN, if available. Blank if unknown.',
  },
  {
    ...
    defaultValue: '',
    description:
      'Primary category, e.g. sugar, dairy, fat, fruit, nut_paste, chocolate_cocoa, stabilizer, flavor, alcohol, water, egg, other.',
  },
  {
    key: 'ingredient_subcategory',
    label: 'Subcategory',
    type: 'string',
    required: false,
    defaultValue: '',
    description: 'Optional finer grouping. Blank if unknown.',
  },
  {
    key: 'approved_for_base',
    label: 'Zatwierdzony do bazy Gellatti',
    type: 'boolean',
    required: false,
    defaultValue: false,
    allowedValues: BOOL,
    description: 'Tak tylko po sprawdzeniu i zatwierdzeniu w głównej bazie składników.',
  },
  {
    key: 'approved_for_engines',
    label: 'Approved for engines',
    type: 'boolean',
    required: true,
    defaultValue: false,
    allowedValues: BOOL,
    description:
      'Technical gate: core composition and POD/PAC are complete enough for PI. Provenance status and confidence remain separate information.',
  },
  {
    ...
    required: true,
    defaultValue: 'draft',
    allowedValues: VERIFICATION_STATUSES,
    description:
      'Informational provenance/review state. It never replaces Base or Engine technical approvals.',
  },
  {
    key: 'verification_source',
    label: 'Verification source',
    type: 'string',
    required: false,
    defaultValue: '',
    description:
      'Where the data came from (label, supplier sheet, external reference, etc.). Blank if unknown.',
  },
  {
    ...
    required: false,
    defaultValue: null,
    description: 'YYYY-MM-DD when last verified. Null if never verified.',
  },
  {
    key: 'data_confidence_percent',
    ...
    max: 100,
    description:
      '0–100 confidence in the data. 0 = no confidence yet (default), not a verified measurement.',
  },
  ...
  /* ── composition (per 100 g) ────────────────────────────────────────────── */
  {
    ...percent(
      'water_percent',
      'Water %',
      'Water content per 100 g. Blank = unknown; 0 = verified zero.',
    ),
    required: true,
  },
  ...
  percent(
    ...
    'Aerating protein %',
    'Dairy/aerating protein per 100 g (excludes non-aerating protein).',
  ),
  ...
  percent('acidity_percent', 'Acidity %', 'Titratable acidity per 100 g.'),
  {
    ...
    max: 100,
    unit: '°Bx',
    description: 'Degrees Brix (not a percent). Blank = unknown.',
  },
  ...
  /* ── engine values ──────────────────────────────────────────────────────── */
  {
    ...
    defaultValue: null,
    min: 0,
    unit: 'relative, sucrose = 100',
    description:
      'Relative sweetening power (sucrose = 100; may exceed 100). Store source + confidence when external. Blank = unknown.',
  },
  {
    key: 'pac_value',
    label: 'PAC',
    ...
    unit: 'relative, sucrose = 100',
    description:
      'Freezing-power source of truth (net anti-freezing, sucrose = 100; may exceed 100). Blank = unknown. Ingredient-level NPAC was REMOVED (v0.95) — recipe-level NPAC is derived by the engine; do not add npac_value back.',
  },
  {
    key: 'de_value',
    label: 'DE',
    ...
    min: 0,
    max: 100,
    description: 'Dextrose equivalent for syrups (0–100). Blank = unknown.',
  },
  {
    key: 'sweetness_factor',
    label: 'Sweetness factor',
    type: 'number_or_null',
    required: false,
    defaultValue: null,
    min: 0,
    description: 'Optional sweetness coefficient. Blank = unknown.',
  },
  {
    key: 'freezing_factor',
    label: 'Freezing factor',
    type: 'number_or_null',
    required: false,
    defaultValue: null,
    min: 0,
    description: 'Optional freezing coefficient. Blank = unknown.',
  },
  {
    key: 'stabilizer_activity',
    label: 'Stabilizer activity',
    type: 'number_or_null',
    required: false,
    defaultValue: null,
    min: 0,
    description: 'Optional stabilizer strength index. Blank = unknown.',
  },
  {
    key: 'recommended_dosage_percent_min',
    label: 'Recommended dosage % (min)',
    type: 'number_or_null',
    required: false,
    defaultValue: null,
    min: 0,
    max: 100,
    description: 'Lower recommended dosage of total mix. Blank = unknown.',
  },
  {
    key: 'recommended_dosage_percent_max',
    label: 'Recommended dosage % (max)',
    type: 'number_or_null',
    required: false,
    defaultValue: null,
    min: 0,
    max: 100,
    description: 'Upper recommended dosage of total mix. Blank = unknown.',
  },

  /* ── nutrition / cost ───────────────────────────────────────────────────── */
  {
    key: 'kcal_per_100g',
    label: 'Energy (kcal/100 g)',
    type: 'number_or_null',
    required: false,
    defaultValue: null,
    min: 0,
    unit: 'kcal per 100 g',
    description: 'Energy per 100 g. Blank = unknown.',
  },
  {
    key: 'cost_per_kg',
    label: 'Cost per kg',
    ...
    defaultValue: null,
    min: 0,
    description: 'Cost per kg. Blank = unknown; 0 = verified free/zero cost, never missing.',
  },
  {
    key: 'currency',
    label: 'Currency',
    ...
    required: false,
    defaultValue: '',
    description: 'ISO 4217 currency for cost_per_kg, e.g. EUR. Blank if unknown.',
  },
  ...
  /* ── food safety / usage ────────────────────────────────────────────────── */
  {
    ...
    required: false,
    defaultValue: '',
    description: 'Pipe/semicolon-separated allergen list. Blank if unknown.',
  },
  {
    key: 'vegan',
    label: 'Vegan',
    ...
    allowedValues: BOOL_OR_UNKNOWN,
    description: 'true / false / unknown. Default unknown — never guess.',
  },
  {
    key: 'dairy_free',
    label: 'Dairy free',
    ...
    defaultValue: 'unknown',
    allowedValues: BOOL_OR_UNKNOWN,
    description: 'true / false / unknown. Default unknown.',
  },
  {
    key: 'gluten_free',
    label: 'Gluten free',
  ...
  },
  {
    ...
    allowedValues: BOOL_OR_UNKNOWN,
    description:
      'true / false / unknown. Default unknown — if unknown and the ingredient may contain alcohol, it is NOT engine-approvable.',
  },
  {
    key: 'storage_type',
    label: 'Storage type',
    ...
    required: false,
    defaultValue: 'unknown',
    allowedValues: STORAGE_TYPES,
    description: 'ambient / chilled / frozen / dry / unknown. Default unknown.',
  },
  {
    key: 'shelf_life_days',
    ...
    min: 0,
    unit: 'days',
    description: 'Shelf life in days. Blank = unknown.',
  },
  {
    key: 'usage_notes',
    label: 'Usage notes',
    ...
    required: false,
    defaultValue: '',
    description: 'Free-text usage notes. Do not invent. Blank if none.',
  },
  {
    key: 'engine_notes',
    label: 'Engine notes',
    ...
    required: false,
    defaultValue: '',
    description: 'Notes for engine mapping / derivation. Blank if none.',
  },
  {
    key: 'source_url',
    label: 'Source URL',
    ...
    required: false,
    defaultValue: '',
    description: 'Link to the source/proof. Blank if none.',
  },
  {
    key: 'screenshot_reference',
    label: 'Screenshot reference',
    type: 'string',
    required: false,
    defaultValue: '',
    description: 'Reference to a stored screenshot/proof file. Blank if none.',
  },
  {
    ...
    required: false,
    defaultValue: '',
    description: 'Reviewer identity. Blank if never reviewed.',
  },
  {
    ...
    required: false,
    defaultValue: null,
    description: 'YYYY-MM-DD of last review. Null if never reviewed.',
  },
];
