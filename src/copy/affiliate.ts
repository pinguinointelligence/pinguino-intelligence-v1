...
export const affiliateCopyPl: AffiliateCopy = {
  page: {
    ...
    blurb: 'Polecaj Gellatti. Zarabiaj na każdym odnowieniu.',
    contextLabel: 'Affiliate',
  },
  hero: {
    eyebrow: 'Program Affiliate',
    titleLine1: 'Polecaj Gellatti.',
    titleLine2: 'Zarabiaj na każdym odnowieniu.',
  ...
  rates: {
    ...
    eliteName: 'Elite',
    eliteTerms: 'Indywidualne warunki.',
    eliteTalk: 'Porozmawiajmy.',
    eliteBody: 'Dla największych kanałów i partnerstw ustalamy warunki indywidualnie.',
  ...
  audience: {
    ...
    groups: [
      {
        title: 'Twórcy',
        body: 'Prowadzisz kanał, profil albo newsletter o jedzeniu, lodach lub gotowaniu.',
      },
      {
        title: 'Profesjonaliści',
        body: 'Uczysz, doradzasz lub pracujesz z lodziarniami i cukierniami.',
      },
      {
        title: 'Społeczności i media',
        body: 'Masz grupę, forum albo publikację, która ufa Twoim rekomendacjom.',
      },
    ],
  },
  how: {
    ...
    title: 'Trzy kroki.',
    steps: [
      { index: '01', title: 'Zgłoś się', body: 'Krótkie zgłoszenie: kim jesteś i gdzie polecasz.' },
      {
        index: '02',
        title: 'Dostajesz link i kod',
        body: 'Po akceptacji czekają na Ciebie w Panelu Affiliate.',
      },
      {
        index: '03',
  ...
  apply: {
    eyebrow: 'Zgłoszenie',
    title: 'Dołącz do Gellatti Affiliate.',
    body: 'Powiedz nam, gdzie polecasz i do kogo mówisz. Odpowiadamy na każde zgłoszenie.',
    signedOutBody:
      'Zgłoszenie składasz z poziomu swojego konta Gellatti — dzięki temu kod i prowizje od razu należą do Ciebie.',
    signInCta: 'Zaloguj się, aby się zgłosić',
  },
  panel: {
...
export const affiliateCopyEn: AffiliateCopy = {
  page: {
    eyebrow: 'Gellatti',
    title: 'Gellatti Affiliate',
    blurb: 'Recommend Gellatti. Earn on every renewal.',
    contextLabel: 'Affiliate',
  },
  hero: {
  ...
  rates: {
    ...
    eliteName: 'Elite',
    eliteTerms: 'Individual terms.',
    eliteTalk: "Let's talk.",
    eliteBody: 'For the largest channels and partnerships we agree terms individually.',
    eliteCta: "Let's talk",
  },
  calculator: {
    eyebrow: 'Calculator',
