    ...
    builder: {
      ...
      ingredientTable: {
        ...
        role: {
          ...
          additionReadiness: 'CZĘŚCIOWO PODŁĄCZONE',
        },
        recipe: {
          heading: 'Receptura',
        ...
        requiredDialog: {
          ...
          noSubstituteBody:
            'Bez tego składnika PINGÜINO nie może obecnie utworzyć poprawnej wersji tej receptury.',
          ...
          confirmBody:
            'Składnik zostanie usunięty, a przeliczenie PI pozostanie zablokowane do czasu uzupełnienia wymaganej roli.',
        ...
        infeasible: {
          ...
          body: 'Brakuje wymaganego składnika. Przelicz z PI pozostaje zablokowane, dopóki rola nie zostanie uzupełniona.',
        },
      },
    },
    pi: {
