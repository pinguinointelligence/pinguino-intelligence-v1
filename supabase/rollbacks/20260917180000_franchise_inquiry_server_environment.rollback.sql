-- ============================================================================
-- ROLLBACK for 20260917180000_franchise_inquiry_server_environment
-- ============================================================================
-- Restores gellatti_submit_franchise_inquiry_v1 to its 20260910032351 body,
-- byte-identical (a contract test compares them). That body is the defective one:
-- it labels the environment from the request body and puts request values into
-- the mail unescaped. Rolling back brings both defects back.
--
-- It issues no grant or revoke; the anon/authenticated grant is untouched.
