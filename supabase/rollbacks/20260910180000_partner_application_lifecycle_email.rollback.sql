...
--   3. drops the two stamp columns from partner_applications
--
-- WHAT IT DOES NOT DO
...
--   It does not remove app_origins, the resolver or the escape helper: they
--   belong to 20260910175900_mail_origin_and_escaping.sql, whose own rollback
--   refuses while this migration is applied.
