-- ROLLBACK for 20260910220000_partner_application_notification_links.sql
--
-- STATUS: READY / NOT APPLIED. Run only if the forward migration was applied.
-- Restores gellatti_admin_partner_application_action_v1 to the definition that is
-- live today (20260831201000; normalised md5 f718220b7f4d5f10f1e6f7411d2fef19).
