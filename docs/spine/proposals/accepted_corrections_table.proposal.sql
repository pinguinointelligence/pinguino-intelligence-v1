-- ============================================================================
-- PROPOSAL — NOT APPLIED (Spine Slice 16)
-- ============================================================================
-- Proposed table for persisting ACCEPTED optimizer corrections.
--
-- STATUS: design preview only. This file lives OUTSIDE supabase/migrations on
-- purpose and MUST NOT be applied, copied into the live migration path, or run
-- in the SQL editor without explicit owner approval (see the approval checklist
-- in docs/spine/ACCEPTED_CORRECTION_PERSISTENCE_PLAN.md). When approved, it
-- becomes supabase/migrations/0012_accepted_corrections.sql (next number in the
-- NNNN_snake_name convention).
--
...
-- ============================================================================
-- ROLLBACK PLAN (also not applied — for the approved migration's paired down)
-- ============================================================================
