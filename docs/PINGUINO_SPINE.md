...
and the **IF9 multi-step add-only rescue walk** (Phase C Slice 20 — `batchRescueStepSolver`,
smallest-verified-fraction stepping via the Slice-14 override, regulator-verified per step,
direction-guarded; the −12 too-hard fixture becomes an honest `partial_improvement`)
