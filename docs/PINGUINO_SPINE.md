...
direction-guarded; the −12 too-hard fixture becomes an honest `partial_improvement`) and the
**production IF9/IF10 branch UI** (Phase C Slice 21 — `BranchWorkflowPreviews` in Studio: paid-gated,
explicit-click, local non-persisted measurement forms, redacted panel, zero apply/save controls)
