...
(Phase C Slice 7) added 2026-07-07. This is the repo-level companion to the **locked Spine
...
- **NOT STARTED (the Spine's Recipe-Intelligence behavior):** the real gram-solver re-run wired into
  the optimizer routing, batch-size/actual-batch-rescue user flow, stock-shortage flow, User Flow
  ...
  and the *Optimizer routing layer* landed as pure code in Slices 2–7 — unwired.)
