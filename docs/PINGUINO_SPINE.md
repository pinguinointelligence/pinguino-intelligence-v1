...
divergence detection) and the **shadow target-band comparison** (Phase C Slice 12 —
...
comparison** (Slice 12) audits the engine-vs-regulator band gap without changing live engine config.
